...
var _focus = __webpack_require__(1);
...
for (var i = 0; i < 10; i++) {
    ...
    _col.className = 'col-6';
    config.parentElement = _col;
    config.imageSrc = './img/' + i + '.jpg';
    imageContainer.appendChild(_col);
    new _focus2.default(config);
}
...
(function webpackUniversalModuleDefinition(root, factory) {
    if (( false ? 'undefined' : _typeof(exports)) === 'object' && ( false ? 'undefined' : _typeof(module)) === 'object') module.exports = factory();else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["focus"] = factory();else root["focus"] = factory();
